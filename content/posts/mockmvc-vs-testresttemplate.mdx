...
<div style={{
  ...
  {/* API 통합 테스트 */}
  <div style={{
    width: '100%', maxWidth: '360px', padding: '18px 20px',
    background: 'rgba(96, 165, 250, 0.08)', border: '1px solid rgba(96, 165, 250, 0.2)',
    borderRadius: '8px', textAlign: 'center',
  }}>
    <span style={{ fontSize: '0.85rem', fontWeight: 600, color: 'rgba(96, 165, 250, 0.9)' }}>API 통합 테스트</span>
    <span style={{ display: 'block', fontSize: '0.7rem', color: 'rgba(96, 165, 250, 0.7)', marginTop: '2px' }}>(TestRestTemplate)</span>
    <div style={{ width: '60%', height: '1px', background: 'rgba(96, 165, 250, 0.15)', margin: '10px auto' }} />
    <span style={{ display: 'block', fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)', lineHeight: '1.6' }}>
      End-to-End 검증<br />
      실제 HTTP 요청/응답 검증<br />
      실제 포트 사용 (RANDOM_PORT)
    </span>
  </div>

  {/* 화살표 + 라벨 */}
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '4px 0' }}>
    <div style={{ width: '2px', height: '16px', background: 'rgba(96, 165, 250, 0.3)' }} />
    <div style={{ width: 0, height: 0, borderLeft: '6px solid transparent', borderRight: '6px solid transparent', borderTop: '8px solid rgba(96, 165, 250, 0.4)' }} />
    <span style={{ fontSize: '0.6rem', color: 'rgba(96, 165, 250, 0.5)', marginTop: '4px' }}>실제 HTTP 요청</span>
  </div>
  ...
  <div style={{
    ...
    <span style={{ fontSize: '0.85rem', fontWeight: 600, color: 'rgba(139, 92, 246, 0.9)' }}>DispatcherServlet</span>
    <span style={{ display: 'block', fontSize: '0.7rem', color: 'rgba(139, 92, 246, 0.7)', marginTop: '2px' }}>(실제 서버)</span>
    <div style={{ width: '60%', height: '1px', background: 'rgba(139, 92, 246, 0.15)', margin: '10px auto' }} />
    <span style={{ display: 'block', fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)', lineHeight: '1.6' }}>
      DTO 직렬화/역직렬화<br />
      라우팅, 예외 처리<br />
      HTTP 헤더 처리
  ...
  {/* 화살표 */}
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '4px 0' }}>
    <div style={{ width: '2px', height: '16px', background: 'rgba(139, 92, 246, 0.3)' }} />
    <div style={{ width: 0, height: 0, borderLeft: '6px solid transparent', borderRight: '6px solid transparent', borderTop: '8px solid rgba(139, 92, 246, 0.4)' }} />
  </div>
  ...
  <div style={{
    ...
    <span style={{ fontSize: '0.85rem', fontWeight: 600, color: 'rgba(74, 222, 128, 0.9)' }}>Service 계층</span>
    <span style={{ display: 'block', fontSize: '0.7rem', color: 'rgba(74, 222, 128, 0.7)', marginTop: '2px' }}>(이미 통합 테스트됨)</span>
    <div style={{ width: '60%', height: '1px', background: 'rgba(74, 222, 128, 0.15)', margin: '10px auto' }} />
    <span style={{ display: 'block', fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)', lineHeight: '1.6' }}>
      비즈니스 로직 검증<br />
      트랜잭션 처리
    </span>
  ...
  {/* 화살표 */}
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '4px 0' }}>
    <div style={{ width: '2px', height: '16px', background: 'rgba(74, 222, 128, 0.3)' }} />
    <div style={{ width: 0, height: 0, borderLeft: '6px solid transparent', borderRight: '6px solid transparent', borderTop: '8px solid rgba(74, 222, 128, 0.4)' }} />
  </div>
  ...
  <div style={{
    ...
    <span style={{ fontSize: '0.85rem', fontWeight: 600, color: 'rgba(251, 146, 60, 0.9)' }}>Domain + Database</span>
  </div>
</div>
